...
class RestModule extends CmfModule {
     ...
     *
     * @return array
     * @filter passport\beforeCreate
     * @author Leo Ning <windywany@gmail.com>
     * @date   2021-11-07 12:19:49
     * @since  1.0.0
     */
    public static function bCreatePassport(array $data): array {
        if (isset($data['channel']) && $data['channel']) {
            if (!AppChannelForm::sexist(['channel' => $data['channel'], 'status' => 1, 'deleted' => 0])) {
                $data['channel'] = 'guanfang';
            }
        } else {
            $data['channel'] = 'guanfang';
        }
